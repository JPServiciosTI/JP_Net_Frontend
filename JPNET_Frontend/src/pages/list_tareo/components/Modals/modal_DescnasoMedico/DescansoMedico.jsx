  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = await post({
        url: "/empleado/register/descansosmedicos",
        data: {
  ...
  return (
    <form action="">
      ...
      <Form.Group className="formTime" >
        ...
        <Form.Control className="controlTime" type="date" required onChange={handleChange2}/>
      </Form.Group>
      <Form.Group className="formTime" >
        <label htmlFor="">Link:</label>
        <Form.Control className="controlTime" type="text" required onChange={handleChange3} />
      </Form.Group>
