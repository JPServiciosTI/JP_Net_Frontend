      ...
      try {
        const registro = await post({
          ...
          data: {
            ...
            salarioTentativo: salarioTentativo.toUpperCase(),
            cargOptar: cargOptar,
            mesesDeExperiencia: mesesDeExperiencia.toUpperCase(),
            linkCV: linkCV,
          },
        });
    ...
    return (
      <>
        <FormGroup>
          ...
          <div className="personalC">
            <Label for="linkCv">
              Link Del CV en Drive: <span>*</span>
            </Label>
            <Input
              type="text"
              name="linkCv"
